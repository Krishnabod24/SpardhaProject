...
<div class="jumbotron" >
  ...
  <div class="container text-center">
    <h1 style="background-color:#C0C0C0;color:black;margin:30px;padding:7px;"><i><b>Novels And Magazines</b></i></h1>      
 </div>
</div>
   ...
   <div class="row">
        <div class="col-lg-3" style="background-color:#e8e8e8;">
		  <?php
			...
			$sql="select username,image,status from sell where category='Novels'";
		...
		<div class="col-lg-5" style="background-color:#e8e8e8;width:750px;">
		 <?php
			...
			$sql="select * from sell where category='Novels'";
			$res=mysqli_query($con,$sql);
			while($row=mysqli_fetch_array($res))
			{    
		       $status=$row['status'];
